...
<table class="table my-4">
    ...
    <?php if($rows == $pg){
     ...
     <tr class="text-center">
        ...
        <td class="badge badge-secondary my-2 ml-1"><a  href=<?=$base_url_for_controller. 'edit/' . '?id=' . $each_bankrupt_phys->id?>>edit</a></td>
        <td class="badge badge-danger my-2 ml-1 "><a id='delete_manager' href="<?=$base_url_for_controller . 'delete/' . '?pg='. $pg . '&page='. $curpage .'&id=' . $each_bankrupt_phys->id?>" onclick="delete_manager()">delete</a></td> 
